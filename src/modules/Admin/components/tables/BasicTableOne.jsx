...
const userData = [
    {
        id: 1,
        user: { image: "/src/assets/images/user-17.jpg", name: "Lindsey Curtis", email: "lindsey@example.com" },
        role: "User",
    ...
    {
        id: 3,
        user: { image: "/src/assets/images/user-17.jpg", name: "Zain Geidt", email: "zain.g@example.com" },
        role: "User",
...
const restaurantApprovalData = [
    {
        id: 101,
        user: { image: "/src/assets/images/user-18.jpg", name: "Kaiya George", email: "kaiya.g@biz.com" },
    ...
    {
        id: 102,
        user: { image: "/src/assets/images/user-20.jpg", name: "Abram Schleifer", email: "abram@digital.co" },
